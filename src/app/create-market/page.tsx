...
const CreateMarket = () => {
    ...
    try {
      openbookClient
        ...
        .then(async ([transactionInstructions, signers]) => {
          ...
          toast({
            description: `Create Market tx: ${tx.toString}`,
          });
        })
        .catch((error) => {
  ...
  return (
    <form>
      <PageTitle text="Create Market" />

      <div className="space-y-12">
        <div className="border-b border-[#ADA7C3] pb-12">
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  ...
                  className="block w-full rounded-md border-0 py-1.5 pl-2 border-[#ADA7C3] text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-white-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  ...
                  className="block w-full rounded-md border-0 border-[#ADA7C3] py-1.5 pl-2  text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-white-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
